...
- [ ] sets (52) (page 18 ✓)
- [x] benyamin (ex=> w3, book) https://colab.research.google.com/drive/1Api2TwKwDKvJsd_4pxjH0AxgjGi0VK_9?authuser=1#scrollTo=lgZ275XKeRxK
### آمار و احتمال مهندسی
- [ ] تمرین
- [ ] جزوه احتمال زارع
### طراحی کامپیوتری سیستم 
  - [[2.-Principles.pdf]]
...
- [ ] تمرین صفحه ۲۹
### روش پژوهش ارائه
- [ ] تکمیل مقاله / پایان نامه 
- [x] ارسال مجدد پروپزال
### آشنایی با صنعت
- [ ] پایان نامه رو ارائه بدم؛ جنریت pdf گاما
### آز مدار الکتریکی
- [ ] گزارش کار آزمایش
